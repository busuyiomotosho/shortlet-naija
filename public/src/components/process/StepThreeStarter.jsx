      ...
      <div className="grid grid-cols-2 gap-10 items-center">
        <div className="flex flex-col gap-4 text-airbnb-light-black">
          ...
          <h1 className="text-4xl">
            <strong>Almost there, final steps!</strong>
          </h1>
          <p className="text-xl">
            Finally, you'll choose the guest you want to start with, then set
            your nightly price. Just answer the next few questions and publish
            when you're ready.
          </p>
        </div>
        <div>
